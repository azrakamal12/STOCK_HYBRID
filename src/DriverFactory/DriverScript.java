...

{
    ...
    ExtentReports reports= new ExtentReports("C:\\Users\\kamal.a\\Documents\\MyNewWorkspace\\Stock_Accounting\\Reports\\"+TCModule+FunctionLibrary.generateDate()+".html");
	
	//iterate all rows in ApplicationLogin sheet
	for(int j=1;j<=excel.rowCount(TCModule);j++)
	{
	  ExtentTest test= reports.startTest(TCModule);
...
try{
	...
	System.out.println("the browser is "+driver);
    ...
    FileUtils.copyFile(srcFile, new File("C:\\Users\\kamal.a\\Documents\\MyNewWorkspace\\Stock_Accounting\\Screens\\"
